          ...
          <NavbarDashboard></NavbarDashboard>
            <div className="row">
                ...
                <div className="col-md-10 p-4 mx-auto">
                    <h1 className="border-bottom mb-2">Add Menu</h1>

                    <form class="row  bg-secondary shadow mt-5 p-5 rounded container shadow" onSubmit={handleSubmit}>
                        <div className="col-md-6">
                            <label class="form-label fw-bolder text-white">Food Name</label>
                            <input type="text" name="title" onBlur={handleBlur} class="form-control" placeholder="Enter Food name" />
                        </div>
                        <div className="col-md-6">
